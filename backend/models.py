...
class Exercise(Base):
    ...
    exercise_id = Column(String, unique=True)  # ID of the exercise
...
class AssignedExercise(Base):
    ...
    exercise_id = Column(
        String, ForeignKey("exercises.exercise_id")
    )  # Foreign key referencing the 'exercise_id' column of the 'exercises' table
    date = Column(
